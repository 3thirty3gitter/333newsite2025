...
const ScrapeProductUrlOutputSchema = z.object({
  ...
  images: z.array(z.string().url()).optional().describe('An array of URLs for all product images found on the page. Find the highest resolution images available.'),
  ...
  })).optional().describe('An array of all product variants, such as size or color.'),
});
